...
@section('title')
Nota Persalinan Baru | BPM Wolita
@endsection

@section('content')
    <div class="portlet">
        <div class="portlet-title text-bold">
            NOTA PERSALINAN BARU
        </div>
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <form action="{{ route('notapersalinan.store') }}"  method="post" enctype="multipart/form"class="form-horizontal">
                @csrf
                <div class="form-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label col-md-3">Persalinan</label>
                                <div class="col-md-9">
                                    <select class="form-control" name="persalinan_id">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label col-md-3">Lama Menginap</label>
                                <div class="col-md-9">
                                    <input type="number" name="lama_menginap" class="form-control" placeholder="persalinan_ke" required>
                                </div>
                            </div>
                        </div>
                        <!--/span-->
